...
class Student extends Authenticatable
{
    ...
    protected $guarded =[];
     // protected $guarded =['Date_Birth','academic_year','timestamps','softDeletes','parent_id','nationalitie_id','parent_id','blood_id'];
    // id  name  email  password gender_id Grade_id Classroom_id section_id
    //  nationalitie_id blood_id Date_Birth
//  parent_id   academic_year  softDeletes timestamps
